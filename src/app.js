...
function renderOnboarding(step=0) {
  const root=$('#onboarding'); const content=[
    {k:'ORIENTATION / 01',h:'You crossed into a strange machine.',p:'Shape Rotator is a 10-week program turning cryptography and AI research into products people can use.',visual:`<svg viewBox="0 0 300 300" fill="none"><circle cx="150" cy="150" r="96" fill="#f0b90b"/><g stroke="#f4f6f8" stroke-opacity=".6"><ellipse cx="150" cy="150" rx="96" ry="35"/><ellipse cx="150" cy="150" rx="35" ry="96"/><circle cx="150" cy="150" r="96"/></g></svg>`},
    ...
    {k:'ORIENTATION / 03',h:'Follow what can become useful.',p:'Browse teams, inspect the dependency field, or answer three signals to route toward the right conversations.',visual:`<svg viewBox="0 0 300 300" fill="none" stroke="#f4f6f8"><circle cx="60" cy="90" r="18"/><circle cx="230" cy="70" r="25"/><circle cx="155" cy="220" r="31"/><path d="M78 88 205 72M72 105l65 92m40 2 42-106" stroke-opacity=".45"/><circle cx="155" cy="220" r="4" fill="#f0b90b" stroke="none"/></svg>`}
  ][step];
